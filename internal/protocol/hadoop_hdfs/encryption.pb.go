...
const file_encryption_proto_rawDesc = "" +
	"\n" +
	"\x10encryption.proto\x12\vhadoop.hdfs\x1a\n" +
	"hdfs.proto\"N\n" +
	" CreateEncryptionZoneRequestProto\x12\x10\n" +
	"\x03src\x18\x01 \x02(\tR\x03src\x12\x18\n" +
	"\akeyName\x18\x02 \x01(\tR\akeyName\"#\n" +
	"!CreateEncryptionZoneResponseProto\"1\n" +
	"\x1fListEncryptionZonesRequestProto\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\x03R\x02id\"\xe7\x01\n" +
	"\x13EncryptionZoneProto\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\x03R\x02id\x12\x12\n" +
	"\x04path\x18\x02 \x02(\tR\x04path\x123\n" +
	"\x05suite\x18\x03 \x02(\x0e2\x1d.hadoop.hdfs.CipherSuiteProtoR\x05suite\x12]\n" +
	"\x15cryptoProtocolVersion\x18\x04 \x02(\x0e2'.hadoop.hdfs.CryptoProtocolVersionProtoR\x15cryptoProtocolVersion\x12\x18\n" +
	"\akeyName\x18\x05 \x02(\tR\akeyName\"t\n" +
	" ListEncryptionZonesResponseProto\x126\n" +
	"\x05zones\x18\x01 \x03(\v2 .hadoop.hdfs.EncryptionZoneProtoR\x05zones\x12\x18\n" +
	"\ahasMore\x18\x02 \x02(\bR\ahasMore\"t\n" +
	"#ReencryptEncryptionZoneRequestProto\x129\n" +
	"\x06action\x18\x01 \x02(\x0e2!.hadoop.hdfs.ReencryptActionProtoR\x06action\x12\x12\n" +
	"\x04zone\x18\x02 \x02(\tR\x04zone\"&\n" +
	"$ReencryptEncryptionZoneResponseProto\"4\n" +
	"\"ListReencryptionStatusRequestProto\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\x03R\x02id\"\xfa\x02\n" +
	"\x1bZoneReencryptionStatusProto\x12\x0e\n" +
	"\x02id\x18\x01 \x02(\x03R\x02id\x12\x12\n" +
	"\x04path\x18\x02 \x02(\tR\x04path\x129\n" +
	"\x05state\x18\x03 \x02(\x0e2#.hadoop.hdfs.ReencryptionStateProtoR\x05state\x12*\n" +
	"\x10ezKeyVersionName\x18\x04 \x02(\tR\x10ezKeyVersionName\x12&\n" +
	"\x0esubmissionTime\x18\x05 \x02(\x03R\x0esubmissionTime\x12\x1a\n" +
	"\bcanceled\x18\x06 \x02(\bR\bcanceled\x12&\n" +
	"\x0enumReencrypted\x18\a \x02(\x03R\x0enumReencrypted\x12 \n" +
	"\vnumFailures\x18\b \x02(\x03R\vnumFailures\x12&\n" +
	"\x0ecompletionTime\x18\t \x01(\x03R\x0ecompletionTime\x12\x1a\n" +
	"\blastFile\x18\n" +
	" \x01(\tR\blastFile\"\x85\x01\n" +
	"#ListReencryptionStatusResponseProto\x12D\n" +
	"\bstatuses\x18\x01 \x03(\v2(.hadoop.hdfs.ZoneReencryptionStatusProtoR\bstatuses\x12\x18\n" +
	"\ahasMore\x18\x02 \x02(\bR\ahasMore\",\n" +
	"\x18GetEZForPathRequestProto\x12\x10\n" +
	"\x03src\x18\x01 \x02(\tR\x03src\"Q\n" +
	"\x19GetEZForPathResponseProto\x124\n" +
	"\x04zone\x18\x01 \x01(\v2 .hadoop.hdfs.EncryptionZoneProtoR\x04zone*A\n" +
	"\x14ReencryptActionProto\x12\x14\n" +
	"\x10CANCEL_REENCRYPT\x10\x01\x12\x13\n" +
	...
	"\tCOMPLETED\x10\x03B}\n" +
	"%org.apache.hadoop.hdfs.protocol.protoB\x15EncryptionZonesProtosZ:github.com/colinmarc/hdfs/v2/internal/protocol/hadoop_hdfs\xa0\x01\x01"
