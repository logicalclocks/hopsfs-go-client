...
const file_datatransfer_proto_rawDesc = "" +
	...
	"\fcipherOption\x18\x04 \x03(\v2\x1e.hadoop.hdfs.CipherOptionProtoR\fcipherOption\x12K\n" +
	"\x0fhandshakeSecret\x18\x05 \x01(\v2!.hadoop.hdfs.HandshakeSecretProtoR\x0fhandshakeSecret\"L\n" +
	"\x1bDataTransferEncryptorStatus\x12\v\n" +
	"\aSUCCESS\x10\x00\x12\x15\n" +
	"\x11ERROR_UNKNOWN_KEY\x10\x01\x12\t\n" +
	"\x05ERROR\x10\x02\"B\n" +
	"\x14HandshakeSecretProto\x12\x16\n" +
	"\x06secret\x18\x01 \x02(\fR\x06secret\x12\x12\n" +
	"\x04bpid\x18\x02 \x02(\tR\x04bpid\"\xc0\x01\n" +
	...
	"\x10bytesPerChecksum\x18\x02 \x02(\rR\x10bytesPerChecksum\"\xb3\t\n" +
	...
	"\x12targetStorageTypes\x18\f \x03(\x0e2\x1d.hadoop.hdfs.StorageTypeProtoR\x12targetStorageTypes\x121\n" +
	"\x10allowLazyPersist\x18\r \x01(\b:\x05falseR\x10allowLazyPersist\x12\x1f\n" +
	...
	"\x12TRANSFER_FINALIZED\x10\b\"\x8c\x02\n" +
